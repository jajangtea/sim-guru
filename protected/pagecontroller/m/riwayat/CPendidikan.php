...
class CPendidikan extends MainPageM {
    ...
    protected function populateData($search = false) {
        if ($search) {
            ...
            $str = "SELECT rp.id,rp.jenjang,rp.nm_jurusan,rp.nm_sekolah,rp.th_lulus,rp.ipk,rp.nip,p.nama_lengkap FROM r_pendidikan rp
INNER JOIN pegawai p on rp.nip=p.nip";
        }
    ...
    public function saveData($sender, $param) {
        if ($this->Page->isValid) {
            $nm_sekolah = addslashes($this->cmbAddJenjang->Text);
