...
class CUserDISDIK extends MainPageM {
    ...
    protected function populateData() {
        ...
        $str = "SELECT userid, username,s.nama as sekolah, page FROM user u join sekolah s on u.kode_sekolah=s.kode where page='m' ORDER BY username ASC LIMIT $offset,$limit";
